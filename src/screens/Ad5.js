...
export default function Apps() {
    useEffect(() => {
        process.env.REACT_APP_AD5?window.location.href = process.env.REACT_APP_AD5:null
        // window.location.href = "https://google.com";  
    }, []);
    return (
        
        process.env.REACT_APP_AD5?<div></div>:<div class="row" style={{marginBottom:75,marginTop:75}}>
        {/* <div class="col-xs-6"> */}
        <div class="col-sm-6">
